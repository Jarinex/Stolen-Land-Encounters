...
namespace TweakMod
{
    class SpellsTweaks
    {
        ...
        static void testsummongorum2()
        {
            ...
            var ability = Helpers.CreateAbility("Summon Spirits 2",
                "Summon Spirits",
               "Summon the spirits of recently slain clerics of gorum so that they may exact revenge on their enemy.",
                "",
                null,
            ...
            var summoncleric_resource2 = Helpers.CreateAbilityResource("summonclericResource2", "", "", "", null);
            summoncleric_resource2.SetFixedResource(1);
